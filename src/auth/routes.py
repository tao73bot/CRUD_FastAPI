...
from .schemas import UserCreate, User, UserLogin, UserBook
...
@auth_router.get("/me", response_model=UserBook)
async def get_current_user(
    user=Depends(get_current_user), _: bool = Depends(role_cheacker)
):
    return user
